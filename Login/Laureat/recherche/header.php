...
<nav>
        <div class="hide" id="part1">
            ...
            <ul>
                <li><a href="../souvenir/gsouvenirs.php" style="text-decoration:none;color:black;">SOUVENIR</li></a>
                <li><a href="../avis/sabmit-avis.php" style="text-decoration:none;color:black;">AVIS</li></a>
                <li><a href="search.php" style="text-decoration:none;color:black;">RECHERCHER</li></a>
            </ul>
        </div>
        ...
        <div id="part2">
          <form class="form-inline my-2 my-lg-0" method="GET" action="search.php">
            ...
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="chich">Search</button>
          </form>
          <button class="btn btn-outline-success my-2 my-sm-0" type="button" id="voice-search-btn" aria-label="Voice search">
            ...
            <div class="toggle">
                <a href="profile.php?id=<?php echo $_SESSION['user_data']['Identifiant']; ?>">Profile</a>
